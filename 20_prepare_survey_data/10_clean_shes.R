...
# into the form required to estimate attributable fractions
...
# scot_pops <- fread("10_inputs/pop_sizes_scotland_national_v1_2022-12-13_mort.tools_1.5.0.csv")
...
write.table(shes_data, paste0("30_intermediate_data/tobalc_consumption_scot_national_2008-2019_v1_", Sys.Date(), "_hseclean_", ver, ".csv"), row.names = F, sep = ",")
saveRDS(shes_data, paste0("30_intermediate_data/tobalc_consumption_scot_national_2008-2019_v1_", Sys.Date(), "_hseclean_", ver, ".rds"))
