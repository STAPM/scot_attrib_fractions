...
# data <- readRDS("30_intermediate_data/tobalc_consumption_scot_national_2008-2019_v1_2022-12-18_hseclean_1.9.2.rds")
data <- readRDS("30_intermediate_data/tobalc_consumption_scot_national_2008-2019_v1_2023-01-18_hseclean_1.10.0.rds")
# sapply(data, class)
...
write.table(data_imp, paste0("30_intermediate_data/tobalc_consumption_scot_national_2008-2019_v1_", Sys.Date(), "_hseclean_", ver, "_imputed.csv"), row.names = F, sep = ",")
saveRDS(data_imp, paste0("30_intermediate_data/tobalc_consumption_scot_national_2008-2019_v1_", Sys.Date(), "_hseclean_", ver, "_imputed.rds"))
