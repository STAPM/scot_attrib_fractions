...
# The aim of this code is to estimate the fractions of disease attributable to alcohol - morbidity
...
est_upshift_protect_no <- PAFcalc(data = data_upshift, substance = subtance_handel, 
                       alc_protective = FALSE, use_weights = TRUE, 
                       year_range = (max(years)-4):max(years), pool = TRUE, 
                       subgroups = NULL, mort_or_morb = mort_or_mor,
                       oesoph_subtypes = TRUE)
...
stapmr::WriteToExcel(wb, sheet = "5 year Condition", 
                     title = "Table 1. Alcohol Attributable Fractions for morbidity. For a pooled sample of 2015 to 2019.", 
...
stapmr::WriteToExcel(wb, sheet = "5 year Age band", 
                     title = "Table 2. Alcohol Attributable Fractions for morbidity by age-band. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "5 year Sex", 
                     title = "Table 3. Alcohol Attributable Fractions for morbidity by sex. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "5 year IMD quintile", 
                     title = "Table 4. Alcohol Attributable Fractions for morbidity by Index of Multiple Deprivation quintiles. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "5 year Sex Age IMD", 
                     title = "Table 5. Alcohol Attributable Fractions for morbidity by sex, age-band and Index of Multiple Deprivation quintiles. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Condition", 
                     title = "Table 6. Alcohol Attributable Fractions for morbidity.", est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Age band", 
                     title = "Table 7. Alcohol Attributable Fractions for morbidity by age-band.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Sex", 
                     title = "Table 8. Alcohol Attributable Fractions for morbidity by sex.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series IMD quintile", 
                     title = "Table 9. Alcohol Attributable Fractions for morbidity by Index of Multiple Deprivation quintiles.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Sex Age IMD", 
                     title = "Table 10. Alcohol Attributable Fractions for morbidity by sex, age-band and Index of Multiple Deprivation quintiles.", 
                     est, startCol = 1, startRow = 1)
