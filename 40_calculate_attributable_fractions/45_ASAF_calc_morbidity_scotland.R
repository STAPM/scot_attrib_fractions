...
# The aim of this code is to estimate the fractions of disease attributable to alcohol and tobacco - morbidity
...
stapmr::WriteToExcel(wb, sheet = "5 year Condition", 
                     title = "Table 1. Alcohol and Smoking Attributable Fractions for morbidity. For a pooled sample of 2015 to 2019.", 
...
stapmr::WriteToExcel(wb, sheet = "5 year Age band", 
                     title = "Table 2. Alcohol and Smoking Attributable Fractions for morbidity by age-band. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "5 year Sex", 
                     title = "Table 3. Alcohol and Smoking Attributable Fractions for morbidity by sex. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "5 year IMD quintile", 
                     title = "Table 4. Alcohol and Smoking Attributable Fractions for morbidity by Index of Multiple Deprivation quintiles. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "5 year Sex Age IMD", 
                     title = "Table 5. Alcohol and Smoking Attributable Fractions for morbidity by sex, age-band and Index of Multiple Deprivation quintiles. For a pooled sample of 2015 to 2019.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Condition", 
                     title = "Table 6. Alcohol and Smoking Attributable Fractions for morbidity.", est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Age band", 
                     title = "Table 7. Alcohol and Smoking Attributable Fractions for morbidity by age-band.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Sex", 
                     title = "Table 8. Alcohol and Smoking Attributable Fractions for morbidity by sex.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series IMD quintile", 
                     title = "Table 9. Alcohol and Smoking Attributable Fractions for morbidity by Index of Multiple Deprivation quintiles.", 
                     est, startCol = 1, startRow = 1)
...
stapmr::WriteToExcel(wb, sheet = "Time series Sex Age IMD", 
                     title = "Table 10. Alcohol and Smoking Attributable Fractions for morbidity by sex, age-band and Index of Multiple Deprivation quintiles.", 
                     est, startCol = 1, startRow = 1)
